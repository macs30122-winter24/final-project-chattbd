...
## Code in this repo
The code used to scrape, clean and analyze the the data is inside the "code" file inside of this repository.

### Data gathering
We gathered our data from 4 main sources, Youtube, Reddit, CNN website, and Fox News Website.
...
#### Crawler_YT.py and Scraper_YT.py
These script files were used to first crawl the desired YouTube playlist to gather all links, then to scrape individual videos that fall within our time frame. It gathered the following data from the videos: title, date, channel name, transcript (if available), comments.

The libraries used in these script files are:
- selenium 4.17.2
- numpy 1.24.3
- pandas 2.0.3
- csv
...
- **Nour Abdelbaki:** Youtube scrapping, data cleaning (absorbed into preprocessing notebook), presentation slides, task check up
...
## Video
The video presentation for our project is available [here](https://uchicago.box.com/s/kjb193lga0imlfv7hzkduo02ga4oao32).
